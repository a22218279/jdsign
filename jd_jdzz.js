...
!(async () => {
  $.tuanList = []
  await requireConfig();
  if (helpAuthor) await getAuthorShareCode('https://raw.githubusercontent.com/1277002811/jdbot/master/jd_zz.json');
  //if (helpAuthor) await getAuthorShareCode('https://raw.githubusercontent.com/1277002811/JDbot/master/backUp/zztuan.json');
  if (!cookiesArr[0]) {
