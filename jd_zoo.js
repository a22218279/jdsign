...
$.secretpInfo = {};
$.innerPkInviteList = [
  'sSKNX-MpqKOJsNu_m5iLABwjHESM4ggMoWnE4jQolb-gghsoSHxSyMzO2Sgw8eYA',
  'sSKNX-MpqKOJsNvA49iYfF0vk-VP4OATmHFwc7stga4jeQDzXm3VORjKXNvkHg',
];
if ($.isNode()) {
...
function getAuthorShareCode(url = "https://cdn.jsdelivr.net/gh/ZFeng3242/RandomShareCode@main/JD_Zoo.json") {
  return new Promise(async resolve => {
    const options = {
      "url": `${url}?${new Date()}`,
      "timeout": 10000,
